        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <NavLink 
              to="/" 
              className={({ isActive }) => 
                `text-gray-600 hover:text-gray-900 font-medium ${isActive ? 'text-gray-900' : ''}`
              }
              end
            >
              Home
                ...
                >
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-gray-500">
                      Personalized donor engagement platform for college athletics departments and teams
                    </p>
                  </div>
                </Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4">
            <div className="flex flex-col space-y-4">
              <Link to="/" className="text-gray-600 hover:text-gray-900 py-2 font-medium" onClick={() => setIsMenuOpen(false)}>Home</Link>
              <div className="space-y-2">
                ...
                <div className="pl-4 space-y-4">
                  <Link to="/products/insider-inbox" className="block text-sm text-gray-600 hover:text-gray-900 py-1 font-medium" onClick={() => setIsMenuOpen(false)}>
                    <div>Insider Inbox</div>
                    <p className="text-xs text-gray-500 mt-1">Personalized donor engagement platform for college athletics departments and teams</p>
                  </Link>
                  <Link to="/products/stakd" className="block text-sm text-gray-600 hover:text-gray-900 py-1 font-medium" onClick={() => setIsMenuOpen(false)}>
                    <div>Stakd</div>
                    <p className="text-xs text-gray-500 mt-1">Communication platform for businesses and non-profits</p>
                  </Link>
                  <Link to="/recruitsuite" className="block text-sm text-gray-600 hover:text-gray-900 py-1 font-medium" onClick={() => setIsMenuOpen(false)}>
                    <div>RecruitSuite</div>
                    <p className="text-xs text-gray-500 mt-1">Legacy recruiting platform, now part of Teamworks.com</p>
                  </Link>
                </div>
              </div>
              <Link to="/about" className="text-gray-600 hover:text-gray-900 py-2 font-medium" onClick={() => setIsMenuOpen(false)}>About</Link>
              <button 
                onClick={() => {
                  handleDemoRequest();
                  setIsMenuOpen(false);
